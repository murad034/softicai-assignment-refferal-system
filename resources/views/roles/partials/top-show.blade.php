...
<div class="row mt-1">
    <!-- Column -->
    <div class="col-md-6 col-lg-3 col-xlg-3 pointer"  onclick="location.href='{{ route('roles.index') }}'">
    ...
    <!-- Column -->
    <div class="col-md-6 col-lg-3 col-xlg-3 pointer" onclick="location.href='{{ route('roles.create') }}'">
        <div class="card card-hover">
            <div class="box bg-info text-center">
